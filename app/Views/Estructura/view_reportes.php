        ...
        <div class="row">
            ...
            <div class="col-3">
                <div class="form-group">
                  ...
                  <input type="date"
                    class="form-control" name="fechaIni" id="fechaIni" aria-describedby="helpId" placeholder="">
            ...
            <div class="form-group">
                  ...
                  <input type="date"
                    class="form-control" name="fechaFin" id="fechaFin" aria-describedby="helpId" placeholder="">
